...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Haojun Zhou
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
                ...
                <p className="home__description">Stay Tune everything will be up by the end of the year</p>
                <a href="#contact" className="button button--flex">Hello
                <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
